...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//ВКМ_Лебедева И.А. 04.2025 добавление поставляемых проилей групп доступа
	// БухгалтерITФирмы
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "БухгалтерITФирмы";
	ОписаниеПрофиля.Идентификатор = "4bfd537e-204b-11f0-8998-9065843de371";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'БухгалтерITФирмы'", ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
	ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
	ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	//ВКМ_Лебедева И.А 04.2025 добавление роли массовое создание документов
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеСозданиеДокументов"); 
	 //ВКМ_Лебедева И.А 04.2025
	ОписанияПрофилей.Добавить(ОписаниеПрофиля); 
	
	//Кадровик-расчетчик														  //
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Кадровик-расчетчик";
	ОписаниеПрофиля.Идентификатор = "36e1315f-245b-11f0-8998-9065843de379";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	 //ВКМ_Лебедева И.А 04.2025  добавление роли расчет зарплаты
	...
	ОписаниеПрофиля.Идентификатор = "4bfd537f-204b-11f0-8998-9065843de371";
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеУчетныхЗаписейЭлектроннойПочты");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	 //ВКМ_Лебедева И.А 04.2025  добавление роли работа с документом обслуживания
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "9b0de3ce-24f0-11f0-899a-843de37911f0";
